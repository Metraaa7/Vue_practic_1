        ...
        <div
          ...
          <form class="custom-form">
            <div class="mt-3 row form-group d-flex justify-content-center">
              <div class="col-4">
                <input v-model="name" type="text" class="form-control bg-transparent border-0 border-bottom text-white" placeholder="Им'я" required>
                <div class="invalid-feedback">Будь ласка, введіть ваше им'я.</div>
              </div>
              <div class="col-4">
                <input v-model="phone" type="number" required class="form-control bg-transparent border-0 border-bottom text-white"
                       placeholder="Телефон">
                <div class="invalid-feedback">Будь ласка, введіть ваш телефон.</div>
              </div>
              <div class="col-8 mt-4">
                <input v-model="address" type="text" class="form-control bg-transparent border-0 border-bottom text-white" placeholder="Проспект ювілейний 24" required>
